...
function addExpectContinueMiddleware(options) {
  return (next) => async (args) => {
    var _a2, _b, _c2, _d2;
    const { request } = args;
    if (options.expectContinueHeader !== false && HttpRequest.isInstance(request) && request.body && options.runtime === "node" && ((_b = (_a2 = options.requestHandler) == null ? void 0 : _a2.constructor) == null ? void 0 : _b.name) !== "FetchHttpHandler") {
      let sendHeader = true;
